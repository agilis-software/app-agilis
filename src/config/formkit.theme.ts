 ...
 *
 * @checksum - 018e7fe30e8fc553573e2e0bc1849bb87cb4169af14895322bdf57a0dd1a2636
 * @variables - radius=rounded-lg,accentColor=purple,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 */
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:text__input': {
    ...
    'bg-transparent': true,
    'selection:bg-purple-100': true,
    'placeholder:text-base-content': true,
    'group-data-[disabled]:!cursor-not-allowed': true,
  ...
  'family:dropdown__listitem': {
    ...
    'data-[is-active]:before:ring-purple-500': true,
    'data-[is-active]:before:ring-inset': true,
    'data-[is-active]:before:ring-offset-purple-100': true,
  ...
  'select__input': {
    ...
    'group-data-[prefix-icon]:!pl-0': true,
    'group-data-[suffix-icon]:!pr-0': true,
    'data-[placeholder]:text-base-content': true,
    'group-data-[multiple]:!p-0': true,
    'selection:bg-purple-100': true,
    'dark:data-[placeholder]:text-base-content/50': true,
    'dark:text-neutral-300': true,
    'border-none': true,
    'focus:ring-0': true,
    'bg-none': true,
  ...
  'dropdown__selector': {
    ...
    'data-[placeholder]:text-base-content': true,
    'selection:bg-purple-100': true,
    'dark:data-[placeholder]:text-base-content': true,
    'dark:text-base-content': true,
  },
  ...
  'rating__ratingItem': {
    ...
    'focus-within:outline-purple-600': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
  ...
  'togglebuttons__input': {
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-purple-500': true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-purple-600': true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-purple-600': true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-purple-600': true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-purple-600': true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-purple-600': true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-purple-500': true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-purple-600': true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-purple-600': true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-purple-600': true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-purple-600': true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-purple-600': true,
  },
  'transferlist__outer': {
    'group': true,
    'min-w-0': true,
  ...
  'transferlist__transferlist': {
    ...
    '[&:has(:focus-visible)]:ring-purple-500': true,
    'dark:border-neutral-600': true,
  ...
  'transferlist__transferlistListItem': {
    ...
    '[&.formkit-dropZone]:bg-purple-100': true,
    '[&.formkit-selectionDropZone]:bg-purple-100': true,
    '[&.formkit-touchDropZone]:bg-purple-100': true,
    '[&.formkit-touchSelectionDropZone]:bg-purple-100': true,
    '[&.formkit-longTouch]:bg-purple-100': true,
    'dark:[&.formkit-dropZone]:bg-purple-900': true,
    'dark:[&.formkit-selectionDropZone]:bg-purple-900': true,
    'dark:[&.formkit-touchDropZone]:bg-purple-900': true,
    'dark:[&.formkit-touchSelectionDropZone]:bg-purple-900': true,
    'dark:[&.formkit-longTouch]:bg-purple-900': true,
  },
  ...
  'transferlist__transferlistButton': {
    ...
    'disabled:!text-base-content': true,
    'bg-neutral-50': true,
    'hover:text-purple-600': true,
    'cursor-pointer': true,
    'appearance-none': true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-purple-600': true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-purple-600': true,
  },
...
const globals: Record<string, Record<string, boolean>> = {
  ...
  overlayPlaceholder: {
    'text-base-content': true,
    'dark:text-base-content/50': true,
  },
  overlayLiteral: {
    'text-neutral-700': true,
    'dark:text-neutral-300': true,
